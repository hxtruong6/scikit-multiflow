...
class BaseNeighbors(BaseSKMObject):
    ...
    def __init__(
        ...
        # print(f"metric:{metric} {self.valid_metrics()}")
        # metric:euclidean ['euclidean', 'l2', 'minkowski', 'p', 'manhattan', 'cityblock', 'l1', 'chebyshev', 'infinity']
    ...
    def _get_neighbors(self, X):
        tree = KDTree(
            self.data_window.features_buffer, self.leaf_size, metric=self.metric
        )
